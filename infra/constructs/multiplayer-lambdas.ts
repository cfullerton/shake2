...
export class MultiplayerLambdaConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: MultiplayerLambdaConstructProps) {
    ...
    const addBot = this.createFunction(
      "AddBot",
      "addBot",
      props,
      environment
    ...
    const startNextHand = this.createFunction(
      "StartNextHand",
      "startNextHand",
      props,
      environment
    ...
    props.multiplayerTable.grantReadWriteData(addBot);
    props.multiplayerTable.grantReadWriteData(startGame);
    props.multiplayerTable.grantReadWriteData(startNextHand);
