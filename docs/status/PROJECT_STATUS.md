...
- Mobile multiplayer active-game shell for rendering the public game snapshot, loading the viewer's private hand, subscribing to live game updates, polling quietly as a mobile browser fallback, reconnecting after detected live event gaps, showing table/score/turn/current-trick state, and submitting pass/numeric bid, declarer trump-call, and domino-play actions through AppSync.
